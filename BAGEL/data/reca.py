...
class ReconstructDataset(DistributedIterableDataset):
    def __init__(
    ...
    def get_training_pair(self, image_file):
        ...
        vit_pil_image = clean_pil_image.copy()
        
        clean_tensor = self.transform(clean_pil_image)
        vit_tensor = self.vit_transform(vit_pil_image)

        # 7. Return the (input, label) pair.
        return vit_tensor, clean_tensor
