...
class ChartQAProDataset(DistributedIterableDataset):
    def __init__(
    ...
    def get_data_paths(self, num_used_data):
        self.all_items = self.read_jsonl_file(self.jsonl_path[0])
    ...
    #     extract_dir = 'data/train'  # os.path.join(self.cache_dir, tar_hash)
    ...
    def __iter__(self):
        ...
        while True:
            ...
            for item_idx, data_item in enumerate(data_items_, start=item_start_id):
                try:
                    image_file = data_item['image_path'] # self.data_dir + data_item['omni_edit_id'] + '_src.png'
                    # edited_file = self.data_dir.replace('images', 'images_modified') + data_item['omni_edit_id'] + '_repaint.png'
                    ...
                    # prompt = data_item['spatial_instruction']
                    # print(prompt)
