...
def generate_image(prompt, num_timesteps=50, cfg_scale=10.0, cfg_interval=[0, 1.0], cfg_renorm_min=0., timestep_shift=1.0, num_images=4, resolution=512, device=None):  # added the ``device`` arg
...
if __name__ == "__main__":
    ...
    parser.add_argument('--use_ema', action='store_true', help="Use EMA weights for the model.")
