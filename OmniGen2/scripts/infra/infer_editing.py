...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--instruction",
        type=str,
        # Change the girl's top to blue.
        # Have the figure in the image raise one hand.
        default="Change the girl's top to blue.", 
    ...
    parser.add_argument(
        ...
        default='example_images/1.png',
        help="Path(s) to input image(s)."
    )
    parser.add_argument(
        "--output_image_path",
        type=str,
        default="example_images/1_complex128.png", # _complex128.png
